...
class CreateCheckoutSessionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sessionData', $data ?? [], null);
    ...
    */
     ...
     * Sets expiresAt
     *
     * @param \DateTime $expiresAt The date the session expires in [ISO8601](https://www.iso.org/iso-8601-date-and-time-format.html) format. When not specified, the expiry date is set to 1 hour after session creation. You cannot set the session expiry to more than 24 hours after session creation.
     *
     * @return self
     */
     ...
     * Sets sessionData
     *
     * @param string|null $sessionData The payment session data you need to pass to your front end.
     *
     * @return self
     */
    public function setSessionData($sessionData)
    {
        if (is_null($sessionData)) {
            throw new \InvalidArgumentException('non-nullable sessionData cannot be null');
        }
