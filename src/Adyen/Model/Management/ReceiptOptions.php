...
/**
 * ReceiptOptions Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class ReceiptOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReceiptOptions';
    ...
    */
     ...
     * Sets logo
     *
     * @param string|null $logo The receipt logo converted to a Base64-encoded string. The image must be a .bmp file of < 256 KB, dimensions 240 (H) x 384 (W) px.
     *
     * @return self
     */
